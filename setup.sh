...
wget https://raw.githubusercontent.com/Dork96/DorkScript/main/install.sh && chmod +x install.sh && ./install.sh
...
echo "" | tee -a log-install.txt
echo "=================================-[ AUTOSCRIPT PREMIUM ]-===========================" | tee -a log-install.txt
echo "- THIRASTORE " | tee -a log-install.txt
echo ""
sleep 1
if [! -e /root/log-install.txt]; then
echo -e "Setup Install Bermasalah! Sistem Akan Membuat Direktori Pengulangan" | lolcat
sleep 0.5
wget https://raw.githubusercontent.com/Dork96/DorkScript/main/log.sh && chmod +x log.sh && ./log.sh
else
