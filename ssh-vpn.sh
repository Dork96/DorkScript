...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Dork96/DorkScript/main/password"
...
echo "clear" >> .profile
echo "figlet -f slant THIRASTORE | lolcat" >> .profile
echo "sleep 1" >> .profile
echo "clear" >> .profile
echo "neofetch" >> .profile
echo "echo -e \"\x1b[96m - THIRASTORE\x1b[m\"" >> .profile
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Dork96/DorkScriptmain/nginx.conf"
mkdir -p /home/vps/public_html
echo /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Dork96/DorkScript/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Dork96/DorkScript/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Dork96/DorkScript/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/Dork96/DorkScript/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/Dork96/DorkScript/main/bannerssh.conf"
